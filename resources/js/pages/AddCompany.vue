<template>
  <div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
        <div class="bg-gradient-to-r from-teal-600 to-cyan-600 px-6 py-4 rounded-t-lg">
          <div class="flex items-center">
            ...
            <div>
              <h1 class="text-xl font-semibold text-white">Add New Company</h1>
              <p class="text-teal-100 mt-1">Create a new company profile</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="pb-6">
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                ></textarea>
                <p class="mt-1 text-sm text-gray-500">
                  Provide a brief description of the company's business activities and services
                </p>
              </div>
            </div>
          </div>
      ...
      <!-- Preview Card -->
      <div v-if="form.company_name.trim()" class="mt-6 bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="p-6">
          ...
          <div class="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-lg p-4 border border-teal-200">
            <div class="flex items-start">
              ...
              <div class="ml-4 flex-1">
                <h4 class="text-lg font-semibold text-gray-900">{{ form.company_name }}</h4>
                <p v-if="form.description.trim()" class="mt-2 text-sm text-gray-600 leading-relaxed">
                  {{ form.description }}
                </p>
