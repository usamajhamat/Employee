        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-teal-100 mt-1">
                                    Overview of employee statistics and
                                    analytics
                                </p>
                            </div>
                        </div>
            ...
            >
                ...
                >
                    <div class="flex items-center">
                        <div
                            class="h-12 w-12 rounded-lg bg-orange-100 flex items-center justify-center"
                        >
...
const hostelEmployees = ref(0);

const dashboardAnalyticsData = computed(
    () => store.getters["company/dashboardAnalyticsData"]
);
...
const fetchAndUpdateCharts = async () => {
    ...
    try {
        ...
        await store.dispatch(`company/${FETCH_DASHBOARD_ANALYTICS}`, {
        ...
        hostelEmployees.value = data.candidates_by_residence?.hostel || 0;
        ...
        typeData.value = [
            {
                label: "Hostel",
                value: data.candidates_by_residence?.hostel || 0,
            },
            {
                label: "Walk-in",
                value: data.candidates_by_residence?.walk_in || 0,
            },
        ];
        ...
        statusData.value = [
            ...
            {
                label: "Absconded",
                value: data.candidates_by_status?.absconded || 0,
            },
            {
                label: "Resigned",
                value: data.candidates_by_status?.resigned || 0,
            },
            {
                label: "Rejected",
                value: data.candidates_by_status?.rejected || 0,
            },
