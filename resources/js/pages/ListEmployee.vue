        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6 p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <!-- Company Filter -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1" for="company-filter">
                            Filter by Company
                        </label>
                        <select
                            id="company-filter"
                        ...
                        >
                            ...
                            <option v-for="company in companiesData?.data" :key="company.id"
                    ...
                    <!-- Status Filter -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1" for="status-filter">
                            Filter by Status
                        </label>
                        <select
                            id="status-filter"
            ...
            >
                <div class="relative">
                  ...
                  {{ selectedEmployee?.status || "Pending" }}
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-600">Exit Company Date</label>
                            <p class="mt-1 text-base text-gray-900 font-medium">
