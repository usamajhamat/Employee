<template>
    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
                <div
                    class="h-20 w-20 rounded-full bg-gray-100 flex items-center justify-center mx-auto mb-6"
                >
                        ...
                        <div class="flex items-center space-x-3">
                            <span
                                :class="[
                                    ...
                                    getStatusColor(selectedTodo.status),
                                ]"
                            >
                            ...
                            <span
                                :class="[
                                    'inline-flex items-center px-3 py-1 rounded-full text-sm font-medium',
                                    getPriorityColor(selectedTodo.priority),
                                ]"
                            >
...
function fetchTodos() {
    store.dispatch("todo/" + FETCH_TODOS);
}
...
const todos = ref([
    {
        ...
        description:
            "Write comprehensive documentation for the new employee management system including user guides and technical specifications.",
        status: "in-progress",
        priority: "high",
        due_date: "2024-12-20",
    ...
    },
    {
        ...
        description:
            "Review and process pending employee applications for the Q4 hiring cycle.",
        status: "pending",
        priority: "medium",
        due_date: "2024-12-15",
    ...
    {
        id: 3,
        heading: "Update Company Policies",
        description:
            "Update company policies to reflect new remote work guidelines and benefits structure.",
        status: "completed",
        priority: "low",
        due_date: "2024-12-10",
    ...
    {
        id: 4,
        heading: "Prepare Monthly Report",
        description:
            "Compile monthly performance metrics and prepare presentation for board meeting.",
        status: "pending",
        priority: "urgent",
        due_date: "2024-12-08",
    ...
    {
        id: 5,
        heading: "System Backup Verification",
        description:
            "Verify all system backups are working correctly and data integrity is maintained.",
        status: "cancelled",
        priority: "medium",
        due_date: "2024-12-12",
...
const filteredTodos = computed(() => {
    return todosData.value.filter((todo) => {
        const matchesSearch =
            todo.heading
                .toLowerCase()
        ...
        const matchesPriority =
            ...
            todo.priority === priorityFilter.value;
...
function deleteTodo(todoId) {
    store
        .dispatch("todo/" + DELETE_TODO, { todoId })
        .then(() => {
