<template>
  <div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <!-- ToDos Grid -->
      <div v-if="filteredTodos.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div
        ...
        >
          ...
          <div class="p-6 border-b border-gray-100">
            <div class="flex items-start justify-between mb-3">
              <h3 class="text-lg font-semibold text-gray-900 line-clamp-2">{{ todo.heading }}</h3>
            ...
            <p class="text-sm text-gray-600 line-clamp-3 mb-4">{{ todo.description }}</p>
      ...
      >
        ...
        <div v-if="selectedTodo" class="space-y-6">
          ...
          <div class="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-lg p-6 border border-teal-200">
            <h4 class="text-xl font-bold text-gray-900 mb-2">{{ selectedTodo.heading }}</h4>
...
const todos = ref([
  ...
  },
  {
    ...
    description: 'Update company policies to reflect new remote work guidelines and benefits structure.',
    status: 'completed',
    priority: 'low',
    due_date: '2024-12-10',
  ...
  },
  {
    ...
    description: 'Compile monthly performance metrics and prepare presentation for board meeting.',
    status: 'pending',
    priority: 'urgent',
    due_date: '2024-12-08',
  ...
  },
  {
    ...
    description: 'Verify all system backups are working correctly and data integrity is maintained.',
    status: 'cancelled',
    priority: 'medium',
    due_date: '2024-12-12',
...
const filteredTodos = computed(() => {
  return todos.value.filter(todo => {
    const matchesSearch = todo.heading.toLowerCase().includes(searchQuery.value.toLowerCase()) ||
...
const deleteTodo = (todo) => {
  if (confirm(`Are you sure you want to delete "${todo.heading}"?`)) {
